...
# name_classes = ['bone', 'braise_drumstick', 'chicken', 'chicken_thigh', 'corn', 'duck_blood', 'fried_drumstick', 'fried_mochi_waste', 'loofah', 'mung_bean_noodles', 'sweet_potato']
# name_classes = ['_background_', 'corn', 'duck_blood', 'sweet_potato', 'mung_bean_noodles', 'loofah', 'chicken', 'chicken_thigh', 'braise_drumstick', 'fried_drumstick', 'fried_mochi_waste', 'bone']
