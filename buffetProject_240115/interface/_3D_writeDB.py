...
def writeDB():     
    ...
    recordunit = record.objects.create(user_id=buyer, eat_date=date_part, eat_time=time_part, food_img=food_img, total_weight=total[0], total_cal=total[1], total_pro=total[2], total_carbo=total[3], total_fat=total[4], cost=cost, donut_chart_img=dc_img, sheet_img=sheet_img)
    recordunit.save()
